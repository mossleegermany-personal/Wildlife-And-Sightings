...
IMAGE QUALITY RULE:
- ALWAYS attempt identification regardless of image quality (phone photos, blur, low light are fine).
- Only return identified=false if there is genuinely NO animal visible at all in the image.
- If quality is poor, still identify to the best level you can (family or genus is fine) and note it in identificationReasoning.
